...
RPC_BUDGET_REVISION: 468f3f266387979bb2bdeb3e5094766199d2309c
...
| Write journey | dedicated wallet client | sim_getFeeConfig + sim_estimateTransactionFees + selected contract write + gen_getTransaction | explicit user action | pending intent / until reconciled | single-flight | terminal outcome | 2s / 120 | bounded backoff, cancel only before hash | 124 | 1 | fee quote + FINALIZED + semantic success + method readback |
