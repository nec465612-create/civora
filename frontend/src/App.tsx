...
export const App: React.FC = () => {
  const [surface, setSurface] = useState<'landing' | 'workbench'>('landing');
  ...
  if (surface === 'landing') {
    return <LandingPage onOpenWorkbench={() => setSurface('workbench')} />;
  }

  return (
    <div className="app-layout">
      <button className="back-to-landing" type="button" onClick={() => setSurface('landing')}>← About Civora</button>
