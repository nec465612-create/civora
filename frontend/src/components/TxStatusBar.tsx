...
export const TxStatusBar: React.FC<{ onReconciled?: (data: unknown) => void }> = ({ onReconciled }) => {
  ...
  const getStageMessage = () => {
    switch (stage) {
      ...
      case 'SUBMITTED':
        return 'Transaction submitted to Studio Next. Awaiting inclusion...';
      ...
      <div className="tx-status-content">
        ...
        {hash && (
          <div className="tx-hash-row">
            ...
            <a className="btn btn-sm btn-outline" href={`${appConfig.explorerBaseUrl}/tx/${hash}`} target="_blank" rel="noreferrer">View transaction</a>
          </div>
        )}
      </div>
