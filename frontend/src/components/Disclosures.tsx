  ...
  return (
    <div className="disclosures-banner" role="region" aria-label="Official Disclosures">
      <div className="disclosure-grid">
        ...
        <div className="disclosure-item">
          <strong>Data Revisions &amp; Studio Next:</strong> The Bureau of Labor Statistics routinely revises historical data. Studio Next is a temporary GenLayer preview environment.
        </div>
      </div>
    </div>
  );
